 ...
 * generated in the com.wqzhang.iwebserver package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetNameResponse_QNAME = new QName("http://server.iwebserver.wqzhang.com/", "getNameResponse");
    private final static QName _GetName_QNAME = new QName("http://server.iwebserver.wqzhang.com/", "getName");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.wqzhang.iwebserver
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.iwebserver.wqzhang.com/", name = "getNameResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.iwebserver.wqzhang.com/", name = "getName")
