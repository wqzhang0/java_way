...
public class Tools {
	 ...
	 * @return
	 */
	public static Date str2Date2Day(String date) {
		if (notEmpty(date)) {
	 ...
	 * 旷课计算学时
	 */
	public static String absentRate = "78";
	...
	/**
	 * @return 获取当前时间，格式为yyyyMMddHHmmss
	 */
